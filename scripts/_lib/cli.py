"""scripts/_lib/cli.py — shared scaffolding for the `paios-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("paios-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/paios-foo`
...
VERSION = "0.1.0"  # bumped centrally; every paios-* CLI reports this
