# src/copilot.py
#
# The Copilot integration approach in this module (device-flow auth, model
# picking, and per-request agent/vision header flags) is adapted from
# opencode — https://github.com/anomalyco/opencode (originally
# opencode-ai/opencode) — Copyright (c) 2025 opencode, MIT License.
# The Python port was made in Odysseus (Copyright (c) 2025 Odysseus
# Contributors, MIT) BEFORE the MyPaiOS fork point (upstream commit 8354948) —
# this file already existed there. MyPaiOS added this attribution header (2026).
# Full license text in licenses/opencode-MIT-LICENSE.txt.
...
COPILOT_USER_AGENT = os.environ.get(
    "PAIOS_COPILOT_USER_AGENT", "PAIOS/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "PAIOS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "PAIOS_COPILOT_EDITOR_VERSION", "PAIOS/1.0"
)
