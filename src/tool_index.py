...
COLLECTION_NAME = "paios_tool_index"
...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "browser_navigate": "Open a real headless browser (Chromium) at a URL and read the live page — JavaScript-rendered sites, dashboards, web apps, multi-step browsing. Keeps the page open for follow-up clicks/typing. Use when web_fetch returns nothing (page needs JS) or the task says browse/open the site and click/login/interact.",
    "browser_read": "Re-read the page currently open in the agent browser (more text with full=true, or one element by CSS selector). Part of the browse-the-web flow.",
    "browser_click": "Click a link or button on the open agent-browser page by its visible text or a CSS selector — navigate menus, next pages, tabs, accept buttons.",
    "browser_fill": "Type text into an input field on the open agent-browser page (search boxes, forms) and optionally press Enter to submit. Never for passwords or payment details.",
    "browser_screenshot": "Take a PNG screenshot of the page open in the agent browser and save it to the workspace — visual proof or for a vision model to inspect.",
    ...
    "manage_skills": "Skill management: add, update, publish, or search reusable skills/presets — and run a skill's bundled scripts (list_scripts/run_script).",
