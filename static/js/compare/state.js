...
const state = {
  ...
  _streaming: false,
  // Blind mode hides model names until reveal/vote. PERSISTED preference;
  // defaults to OFF (names visible) — the user asked to see model names.
  _blindMode: (() => { try { return localStorage.getItem('compare-blind') === '1'; } catch (e) { return false; } })(),
  _saveOnClose: false,
  _continueChat: false,
