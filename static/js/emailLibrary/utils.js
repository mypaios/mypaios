...
// ── Multilingual quote-detection regexes — adapted from Mailgun talon ──
// Adapted from talon (https://github.com/mailgun/talon), Copyright (c) Mailgun
// Technologies, Inc., licensed under the Apache License 2.0. Full text in
// licenses/talon-Apache-2.0.txt; see ACKNOWLEDGMENTS.md.
//
// CHANGE NOTICE (Apache-2.0 §4(b)): talon's Python quotation-parsing word lists
// and Original-Message / Forwarded-message separator patterns were re-expressed
// as JavaScript regex source fragments and extended with additional locales
// (CJK, Cyrillic, Greek). This adaptation was made upstream in Odysseus, before
// the MyPaiOS fork point (commit 8354948).
//
// These are partial regex source strings — combined with surrounding patterns
// by callers.
