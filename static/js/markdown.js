...
function initMermaid() {
  if (!window.mermaid || window.__paiosMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__paiosMermaidReady = true;
}
window.paiosInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'paios-thinking-expanded';
