...
//
// Sources (see ACKNOWLEDGMENTS.md → Icons → Provider logos):
//   • Simple Icons (https://simpleicons.org) — CC0-1.0, no notice required:
//     Anthropic, Google Gemini, Meta, Mistral AI, X (xAI/Grok), Perplexity,
//     NVIDIA.
//   • LobeHub Icons (https://github.com/lobehub/lobe-icons) — MIT License,
//     Copyright (c) 2023 LobeHub: DeepSeek and Qwen (both paths are
//     byte-identical to @lobehub/icons-static-svg). Full text in
//     licenses/lobehub-icons-MIT-LICENSE.txt.
//   • Everything else is an original/simplified mark drawn for this project.
//
// These licences cover the SVG renderings only. Every mark depicted remains the
// trademark of its owner and is used nominatively; MyPaiOS is not affiliated
