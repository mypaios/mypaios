"""`paios-research list --status complete` was returning nothing.
...
Part of #2122 (paios-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "paios-research"
    loader = importlib.machinery.SourceFileLoader("paios_research_cli", str(path))
