...
def _load_setup_module():
    spec = importlib.util.spec_from_file_location("paios_setup_under_test", Path("setup.py"))
...
def test_create_default_admin_normalizes_env_username(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("PAIOS_ADMIN_USER", " AdminUser ")
    monkeypatch.setenv("PAIOS_ADMIN_PASSWORD", "temporary-password")
